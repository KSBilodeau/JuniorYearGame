...
public:
    ...
    // Applies damage to the players health
...
private:
    ...
    // Players health flag
    int mHealth;
    // Indicates the maximum value for player health
    int maxHealth;
    
    // Players mana flag
    int mMana;
    // Indicates the current max value for mana
    int mMaxMana;
    
    // Mana regen timer
    int manaTimer;
    
    // Flag indicating if discus is being used
    bool discusFlag;
